    ...
    return (
        <footer className="border-t border-slate-800 bg-slate-900/50 py-8 mt-20">
            <div className="container flex flex-col md:flex-row justify-between items-center gap-4">
                <div className="font-heading text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-500">
                    Abhishek.
                </div>
                <p className="text-slate-500 text-sm font-medium">
                    &copy; {new Date().getFullYear()} All rights reserved. Built with Vite & React.
                </p>

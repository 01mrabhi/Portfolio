                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className="glass-panel p-8 md:p-10 flex flex-col justify-center">
                        ...
                        <div className="flex flex-col gap-6">
                            {/* Email */}
                            <a href="mailto:shekhu652@gmail.com" className="flex items-center gap-4 p-4 rounded-xl bg-slate-800/50 border border-slate-700 hover:border-blue-500 transition-colors group">
                                ...
                                <div>
                                    ...
                                    <p className="text-lg text-white font-medium">shekhu652@gmail.com</p>
                                </div>
                            </a>

                            {/* LinkedIn */}
                            <div className="flex items-center gap-4 p-4 rounded-xl bg-slate-800/50 border border-slate-700 transition-colors group opacity-75 cursor-not-allowed">
                                <div className="w-12 h-12 rounded-full bg-purple-500/20 flex items-center justify-center text-purple-400 transition-all">
                                ...
                                <div>
                                    ...
                                    <p className="text-lg text-white font-medium">Not Available Right Now</p>
                                </div>
                            </div>
                        </div>
                    </div>

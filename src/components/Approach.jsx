...
const PHASES = [
    ...
    },
    {
        ...
        icon: '⚡',
        title: 'Build & Develop',
        desc: 'With a solid blueprint established, I move fast — building flawless, pixel-perfect interfaces backed by robust, scalable code.',
        steps: [
            'Frontend development (React & Next.js)',
            'Backend APIs, security & edge integration',
            'Rigorous testing, debugging & code review',
        ],
    },
    {
        num: 'Phase 3',
        ...
        desc: "Ship it, monitor it, improve it. I hand off meticulously clean code with documentation and ensure everything runs flawlessly in production.",
        steps: [
            'Automated deployment & CI/CD pipelines',
            'Advanced performance tuning & SEO specs',
            'Ongoing continuous support & iteration',
        ],
    },
]
